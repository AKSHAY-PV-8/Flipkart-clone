  ...
  return (
    <section className={style}>
      <div className="bg-white flex justify-center items-center flex-col w-full">
        <header className="flex items-center w-full sticky top-0 justify-between z-10 px-4 py-2 lg:py-3 lg:px-7 md:p-2 h-[67.2px]">

          <div className="flex items-center flex-grow">

            <a href="#" className="block mr-3 no-underline z-30 tracking-normal md:hidden">
              {icon ? (
                <img
                  alt="Menu"
            ...
            <div className="mr-0 pt-1 max-w-[120px] sm:mr-9">
              {homePage ? (
                <a href="#" className="no-underline">
                  <picture title="Flipkart">
                    ...
                    <img
                      ...
                      className="aspect-[4/1] relative -top-1.5"
                    />
                  </picture>
                </a>
              ) : (
                <div className="flex flex-row">
                  <a href="#">
                    <img src="https://static-assets-web.flixcart.com/batman-returns/batman-returns/p/images/logo_lite-ea579c.png" className="w-[23px]" />
                  </a>
                  <div className="text-black table-cell align-middle w-full whitespace-nowrap overflow-x-scroll pl-3">
            ...
            <div className="w-full hidden md:block md:min-w-[200px] lg:w-full">
              <form className="inline-block w-full relative rounded-[8px] bg-[#f0f5ff]">
                <div className="w-full flex justify-between">
                  <button className="h-10 rounded-[2px] cursor-pointer py-2 pr-2 pl-3">
                  ...
                  <input type="text" className="placeholder:text-[18px] w-full font-medium text-black relative" placeholder="Search for Products, Brands and More" />
                </div>
              </form>
            </div>
          </div>
